...
const { create, update, remove, getOne, getAll } = require("../pkg/cars/index");
const { CarCreate, validateCar } = require("../pkg/cars/validate");
...
const addCars = async (req, res) => {
  try {
    ...
    await validateSchema(data, CarCreate);
    await create(data);
...
const updateCars = async (req, res) => {
  try {
    ...
    await validateSchema(data, CarUpdate);
